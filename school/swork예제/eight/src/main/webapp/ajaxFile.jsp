...
/*
 참고 사이드 : https://knowledge-warehouse-jun.tistory.com/8
 
 dataType : 서버에 결과 값으로 반환해주는 데이터를 어떤 자료형으로 받을 것인지 정의.
 생략했을 경우에는 jQuery가 MIME차입들을 보면서 자동으로 결정한다.
