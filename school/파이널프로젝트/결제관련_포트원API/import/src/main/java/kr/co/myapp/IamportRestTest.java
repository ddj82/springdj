...
public class IamportRestTest {
	...
	public final String KEY = "아임포트 Rest Api key";
	//"아임포트 Rest Api Secret로 설정"; 
	public final String SECRET = "아임포트 Rest Api Secret";  
	//아임포트 가맹점 식별코드 값
	public final String IMPORT_ID = "아임포트 가맹점 식별코드 값"; 
	...
	public void payment(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		...
		out.print("<a href='/pay'>쇼핑 계속하기</a><br>");
