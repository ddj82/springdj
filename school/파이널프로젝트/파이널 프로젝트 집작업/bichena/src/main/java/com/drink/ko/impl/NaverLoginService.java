...
public class NaverLoginService {
	...
	public String requestNaverLoginAcceccToken(Map<String, String> resValue, String grant_type, HttpSession session) {
	 ...
	 public UsersVO apiExamMemberProfile(String token1) {
	     ...
	     vo.setU_tel(mobile);
	     String birthday = (response.getAsJsonObject().get("birthyear").getAsString())+(response.getAsJsonObject().get("birthday").getAsString());
	     ...
	     String name = data.getAsJsonObject().get("receiverName").getAsString();
	     vo.setU_name(name);
