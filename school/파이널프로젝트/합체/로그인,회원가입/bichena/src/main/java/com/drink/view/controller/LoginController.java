...
import com.drink.ko.user.CertificationService;
import com.drink.ko.user.KaKaoVO;
import com.drink.ko.user.MailSendService;
...
//		        // 3. 사용자 정보 받기
		...
		vo.setAddr1((String) userInfo.get("zone_number"));
		vo.setAddr2((String) userInfo.get("detail_address"));
		vo.setAddr3((String) userInfo.get("baseAddress"));
