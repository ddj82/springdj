...
<body>
	...
	<form action="reconPw.ko" class="confirmPw" method="post">
		...
		<div><input type="password" id="upw" name="u_pw" minlength="8" maxlength="16" pattern="[a-zA-Z0-9_\-~!@#$%^&*()]+">
			</div><div><input type="button" onclick="passChk()" value="확인"></div>
	</form>
	<!-- 		<p>비밀번호가 기억나지 않으세요? <a href="">비밀번호 재설정</a></p> -->
</body>
