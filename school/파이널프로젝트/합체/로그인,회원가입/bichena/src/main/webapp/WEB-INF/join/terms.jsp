...
<body>
	<div class="wrapSign">
		<div class="a">
			<h2>약관동의</h2>
			<form action="requestCertPage.ko" class="form1" name="form1"
				onsubmit="return sub();" method="post">

				<span><img src="" class="termsB"><label><input
						type="checkbox" name="clause" id="clauseAll" value="clauseAll">전체
						동의하기</label></span><br> <br> <span><img src=""
					class="termsB"><label><input type="checkbox"
						name="clause" id="clause1" value="agree"><small
...
② "쇼핑몰"과 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다.
				...
				<br> <br> <span><img src=""
					class="termsB"><label><input type="checkbox"
						name="clause" id="clause2" value="agree"><small
						style="color: black; font-weight: bold;">[필수] </small>개인정보 수집 및 이용</label></span><br>
				<br>
				<textarea readonly>
