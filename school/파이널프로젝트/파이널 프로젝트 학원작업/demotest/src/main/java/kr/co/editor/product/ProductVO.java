...
public class ProductVO {
	...
	private int p_stock;
	private String pthumbnail; // pthumbnail
//	private String editfile; // pfilename // 에디터로 생성된 jsp파일이름
//	private String edithtml; // pdetail // 에디터로 쓴 내용의 html형식 문자열
	private String pfilename; // pfilename // 에디터로 생성된 jsp파일이름
	private String pdetail; // pdetail // 에디터로 쓴 내용의 html형식 문자열
...
//	}
	...
	public String toString() {
		return "ProductVO [p_no=" + p_no + ", p_name=" + p_name + ", p_price=" + p_price
				+ ", p_desc=" + p_desc + ", p_made=" + p_made + ", p_type=" + p_type
