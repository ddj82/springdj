...
<!--20240503_ym  에디터에서 수정하면 데이터가 직접 들어오는 장소 시작-->
	...
	<form action="${pageContext.request.contextPath }/proDetailInsert.ko" method="post" id="dataTransferForm" enctype="multipart/form-data">
		...
		썸네일 이미지 등록: <input type="file" name="uploadFile" id="pthumbnailimg">
		<input type="text" name="p_name" id="pname" placeholder="상품명 입력">
		<input type="number" name="p_price" id="pprice" placeholder="상품금액 입력">
