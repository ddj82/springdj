...
<body>
<h1>상품 상세 페이지</h1>
<a href="${pageContext.request.contextPath }/updateForm.ko?pno=${pOne.p_no}">
...
<div id="topDiv">
	...
	<div class="topDiv">
		<p>상품명 : ${pOne.p_name }</p>
		<p>상품가격 : <fmt:formatNumber value="${pOne.p_price }" />원</p>
	</div>
</div>
...
window.onload = function(){
		...
		httpReq.open("GET", './productDetailpage.ko?p_no=${pOne.p_no}', false);
