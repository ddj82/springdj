...
<body>
	<div class="wrapSign">
		<div class="a">
			<h2>약관동의</h2>
			<form action="requestCertPage.ko" class="form1" name="form1" onsubmit="return sub();" method="post">
				<span>
					<img src="" class="termsB">
					<label><input type="checkbox" name="clause" id="clauseAll" value="clauseAll">전체 동의하기</label>
				</span>
				<br><br>
				<span>
					<img src="" class="termsB">
					<label><input type="checkbox" name="clause" id="clause1" value="agree"><small style="color: black; font-weight: bold;">[필수]</small>서비스 이용약관</label>
				</span>
				<br>
				<br>
				<textarea readonly>
제1조(목적)
이 약관은 비체나(전자거래 사업자)가 운영하는 홈페이지(이하 "쇼핑몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 비체나와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
...
② "쇼핑몰"과 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다.
				...
				<span>
					<img src="" class="termsB">
					<label><input type="checkbox" name="clause" id="clause2" value="agree"><small style="color: black; font-weight: bold;">[필수] </small>개인정보 수집 및 이용</label>
				</span>
				<br>
				<br>
				<textarea readonly>
...
- 필수 항목의 수집·이용을 동의하지 않는 경우 비체나의 웹 회원가입이 불가합니다.
- 선택 항목의 수집·이용을 동의하지 않는 경우 비체나의 홍보자료를 수신하실 수 없습 니다.
                </textarea>
				<br><br>
				<div id="div1">
